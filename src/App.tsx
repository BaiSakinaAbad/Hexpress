      ...
      <AnimatePresence mode="wait">
        ...
        {currentScreen === 'intro2' && (
          <motion.div
            ...
            animate={{ opacity: 1, scale: 1 }}
            exit={{ opacity: 0, scale: 1.05 }}
            className="z-10 p-10 w-[768px] max-w-[95vw] h-[450px] text-center flex flex-col items-center justify-between"
          >
            <div 
              className="w-full text-2xl mt-4 text-left leading-relaxed text-[#2c1818] font-bold flex-1"
              style={{ textShadow: "2px 2px 0px white, -1px -1px 0px white, 1px -1px 0px white, -1px 1px 0px white, 1px 1px 0px white" }}
            >
              <p className="mb-4 text-[#8b1a1a] h-[80px]">
                 <Typewriter text="Hi! I'm Kiki, a witch-in-training, and I run a little delivery service in this town." speed={35} skip={skipIntro} />
              </p>
              <p className="mb-4 h-[80px]">
              ...
              <p className="text-xl opacity-90 italic text-black h-[80px]">
            ...
            <motion.button 
              ...
              className="px-8 py-3 bg-[#cdebf9] border-2 border-[#1c305c] rounded-full text-2xl shadow-[4px_4px_0_0_#1c305c] hover:translate-x-1 hover:translate-y-1 hover:shadow-none transition-all"
            >
        ...
        {currentScreen === 'knapsack' && (
          <motion.div
            ...
            exit={{ opacity: 0, x: -50 }}
            className="z-10 bg-[#faeec8] border-4 border-black rounded-xl p-8 w-full max-w-5xl shadow-xl flex flex-col items-center gap-6"
          >
        ...
        {currentScreen === 'search' && (
          ...
          >
            ...
            <div className="flex justify-between items-stretch gap-4 flex-1 overflow-hidden">
              <div className="bg-[#faeec8] border-2 border-black p-4 w-64 flex flex-col shadow-md">
              ...
              <div className="flex-1 bg-[#faeec8]/90 border-2 border-black shadow-md overflow-hidden flex flex-col">
            ...
            <div className="flex justify-between items-center mt-2 shrink-0">
              <button 
                ...
                className="px-8 py-3 bg-white border-2 border-black rounded-full text-xl font-bold text-[#8b1a1a] hover:bg-gray-100 transition-colors"
                >
                Back
              </button>
              <button 
                onClick={handleStartTSP}
                className="px-8 py-3 bg-[#faeec8] border-4 border-black rounded-full text-2xl font-bold text-[#8b1a1a] hover:bg-white transition-colors shadow-[4px_4px_0_0_#1c305c] hover:translate-x-1 hover:translate-y-1 hover:shadow-none"
                >
                Simulate Delivery
              </button>
            </div>
        ...
        {currentScreen === 'tsp' && (
          ...
          >
            <div className="flex justify-between items-center bg-[#cdebf9] border-2 border-black p-2 absolute top-4 right-4 z-20 rounded-full px-6 text-[#8b1a1a]">
               <h2 className="text-2xl">Delivery Simulation</h2>
            </div>
            <h1 className="text-3xl text-center text-[#8b1a1a] mt-2 tracking-widest">GHIBLI MAP</h1>
            ...
            <div className="flex-1 w-full border-4 border-[#1c305c] bg-[#8cd3ff] rounded-lg relative overflow-hidden shadow-inner">
               ...
               {tspRoute.length > 0 && (
                 <motion.div
                   className="absolute -translate-x-1/2 -translate-y-1/2 w-12 h-12 bg-black border-2 border-white rounded-full text-white flex items-center justify-center text-2xl shadow-[0_0_15px_rgba(255,255,255,0.5)] z-20"
                   animate={{
            ...
            <div className="flex justify-between items-center bg-white border-2 border-black p-4 rounded-lg shadow">
               <div className="text-xl font-bold flex-1 flex flex-wrap gap-2 items-center">
               ...
               <div className="flex gap-4">
                 <button 
                   ...
                   className="px-6 py-2 bg-gray-200 border-2 border-black text-[#8b1a1a] font-bold rounded-lg hover:bg-gray-300 transition-colors"
                 >
                   Restart
                 </button>
                 <button 
                     ...
                     className="px-8 py-3 bg-[#dcb18c] border-2 border-black rounded-lg text-xl font-black text-[#682414] hover:bg-opacity-80 disabled:opacity-50 disabled:cursor-not-allowed"
                 >
        ...
        {currentScreen === 'exit' && (
          ...
          >
             <div className="z-10 flex flex-col items-center gap-4 text-white drop-shadow-[0_4px_4px_rgba(0,0,0,0.4)]">
                {!showCredits ? (
                    <>
                        <h1 className="text-3xl md:text-5xl font-sans tracking-wide">All deliveries are completed!</h1>
                        <h1 className="text-2xl md:text-4xl font-sans tracking-wide mt-4">Great job helping Kiki today!</h1>
                    </>
                ) : (
                    <motion.div 
                        initial="hidden"
